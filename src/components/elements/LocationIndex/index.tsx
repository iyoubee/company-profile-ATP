  ...
  return (
    <>
      <section className="flex justify-center">
        <div className="flex bg-[#294696] rounded-2xl flex-col-reverse lg:flex-row">
          ...
          <div className="md:w-[500px] w-[300px] md:p-12 p-3 flex flex-col gap-8 justify-center">
            ...
            <div className="w-full text-white">
              ...
              <div className=" border-b-2 md:p-4 pl-2 items-center gap-4 w-full">
                yudiputrasabri789@gmail.com
              </div>
              <div className="w-full flex justify-end hover:cursor-pointer mt-3">
                <div
                  className=" w-fit bg-[#63A3C7] p-2 rounded-lg"
                  onClick={() => {
